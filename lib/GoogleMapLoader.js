  ...
  (0, _createClass3.default)(GoogleMapLoader, [{
    ...
    value: function mountGoogleMap(domEl) {
      ...
      this.setState({ map: map }, function () {
        if (_this.props.onMapInitialized) {
          _this.props.onMapInitialized(map);
        }
      });
    }
  }, {
    ...
    value: {
      ...
      googleMapElement: _react.PropTypes.element.isRequired, /* CIRCULAR_DEPENDENCY. Uncomment when 5.0.0 comes: propTypesElementOfType(GoogleMap).isRequired, */
      onMapInitialized: _react.PropTypes.func
    },
    enumerable: true
  }, {
    key: "defaultProps",
